...
import com.hongda.gmall.realtime.bean.CouponUseOrderBean;
...
//        System.setProperty("HADOOP_USER_NAME", "atguigu");
        ...
        tableEnv.executeSql("create table `ods_db` ( " +
                ...
                "`old` string, " +
                "`ts` string " +
                ")" + MyKafkaUtil.getKafkaDDL("ods_db", "dwd_tool_coupon_order_211027"));
        ...
        //打印测试
        couponUseOrderDS.print("couponUseOrder>>>>>>");
        ...
        //打印测试
        Table table1 = tableEnv.sqlQuery("select * from result_table");
        tableEnv.toAppendStream(table1, Row.class).print("result_table>>>>>>>>>");
