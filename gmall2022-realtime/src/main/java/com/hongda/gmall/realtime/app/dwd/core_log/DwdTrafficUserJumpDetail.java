...
//        DataStreamSource<String> kafkaDS = env.addSource(MyKafkaUtilHongda.getKafkaConsumer(sourceTopic, groupId));
//
//        //TODO 3.将数据转换为JSON对象
...
////            }
////        })
////                .times(2)      //因为模式匹配规则是一样的, 因此可以设置为循环匹配规则, 此处设置循环次数为2次, 注意: 默认为宽松近邻
////                .consecutive() //指定为严格近邻
////                .within(Time.seconds(10));
//
//        //TODO 7.将模式序列作用到流上
...
//                    /**
//                     *
//                     * @param map 为什么value 是一个List<JSONObject>>?? 因为先循环匹配编码风格下, first的匹配结果可能会是多条的.
//                     * @param l
//                     * @return
//                     * @throws Exception
//                     */
...
//                .addSink(MyKafkaUtilHongda.getKafkaProducer(targetTopic));
//
//        //TODO 11.启动任务
